...
BOT_TOKEN = "7161385800:AAHZaWAZc8JDPBZX3W4Gmpiuqmjyz6_COYg"
PAYMENT_CHANNEL = "@payment_stats" #add payment channel here including the '@' sign
OWNER_ID = 6429177904 #write owner's user id here.. get it from @Earning_By_Raj_bot by /id
CHANNELS = ["@Earning_By_Raj"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
